...
describe('usePlaces', () => {
    ...
    /*
    test('stchambe: append multiple places, try to get DistancesResponse', async () => {
        ...
        await act(async () => {
            hook.current.placeActions.append(mockPlace1);
            hook.current.placeActions.append(mockPlace2);
        });
