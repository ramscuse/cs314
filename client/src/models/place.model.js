...
export class Place {
	constructor(placeObj) {
		this.name = placeObj.name ?? placeObj["world.name"] ?? placeObj.leisure ?? placeObj.building ?? placeObj.amenity ?? placeObj.man_made;
		...
		this.municipality = placeObj.municipality ?? placeObj["world.municipality"] ?? placeObj.city ?? placeObj.village ?? placeObj.state_district ?? placeObj.town ?? placeObj.county;
		this.region = placeObj.region ?? placeObj["region.name"] ?? placeObj.state;
		this.country = placeObj.country ?? placeObj["country.name"];
