...
public class TestMicroServer {
    ...
    @Test
    @DisplayName("stchambe: A valid dist request responds with a 200 status")
    public void testValidDistanceRequest() throws IOException {
        String validDistancesRequestJSON = "{\"requestType\":\"distances\", \"earthRadius\":69.69, \"places\": []}";    
