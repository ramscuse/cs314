...
import com.tco.requests.DistancesRequest; //need to add this import -Samuel
import com.tco.requests.FindRequest; //added this import - Samuel
import com.tco.requests.TourRequest; // -Samuel
...
public final class MicroServer {
    ...
    MicroServer(int serverPort) {
        log.info("SAMUEL: serverPort for MicroServer: {}", serverPort);
    ...
    private String processHttpRequest(spark.Request httpRequest, spark.Response httpResponse, Type requestType) {
        ...
        log.info("SAMUEL: Microserver class: processHttpRequest() requestType: {}", requestType);
