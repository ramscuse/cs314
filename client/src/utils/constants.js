...
export const CLIENT_TEAM_NAME = "t25 Ruis Ali";

export const EARTH_RADIUS_UNITS_DEFAULT = { "miles": 3959 };

export const EARTH_RADIUS_UNITS_KILOMETERS = { "kilometers": 6371 };

export const EARTH_RADIUS_UNITS_NAUTICAL_MILES = { "nautical_miles": 3440 };
